...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BluLLgpo.mjs");
...
var manifest = {
	"115610eaad7abc0e589848361f3223445819da3a28b6b34c2dd9a4d7cdb29e27": {
		functionName: "fetchLiveData_createServerFn_handler",
		importer: () => import("./live-data-8ojG8k98.mjs")
	},
	"7e07b01eafd062e35c7d52d1f74f2d478cd3a47e70d72e8193c87df3f0482d0a": {
		functionName: "chatGrok_createServerFn_handler",
		importer: () => import("./grok-DMKkVTNZ.mjs")
	},
	"ed8b339efa8a2cab68902bd9dbbfb7a4c7fb5209b805a609339a84872d18318b": {
		functionName: "imagineGrok_createServerFn_handler",
		importer: () => import("./grok-DMKkVTNZ.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-xdpFHwaW.mjs").then((n) => n.t),

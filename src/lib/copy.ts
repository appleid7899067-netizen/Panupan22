...
export const COPY = {
  th: {
    ...
    continueGuest: "เข้าห้องบัญชาการ",
    ...
    guestBanner: "Grok 4.5 พร้อมใช้ — Puter เป็นทางเลือกสำหรับโมเดลอื่น",
    signInNow: "เชื่อม Puter",
  ...
  en: {
    ...
    continueGuest: "Enter the command center",
    connecting: "Connecting…",
    retryPuter: "Retry Puter",
    popupHint: "Puter is optional. Allow popups only if you want models beyond Grok.",
    guestBanner: "Grok 4.5 is ready — Puter is optional for extra models",
    signInNow: "Connect Puter",

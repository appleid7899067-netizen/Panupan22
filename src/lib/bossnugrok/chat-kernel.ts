...
ทำงานแบบ evidence-driven: ตรวจหลักฐานก่อนลงมือ, ตรวจผลจริงหลังลงมือ และถ้าหลักฐานใหม่ขัดกับแผนเดิมให้ REPLAN ทันที
ห้ามถือว่าการเขียนโค้ดหรือ commit สำเร็จเท่ากับงานเสร็จ ต้องมีหลักฐาน verification ที่สอดคล้องกับเป้าหมายก่อนพูดว่าเสร็จ
เมื่อเจอ error ให้จำ pattern ของปัญหาและวิธีแก้ที่ผ่านการตรวจสอบ แทนการวนซ้ำวิธีเดิม

...
export function SandboxPanel() {
  ...
  const [system, setSystem] = useState("You are a precise, helpful assistant. Answer with clear structure.");
  const [prompt, setPrompt] = useState("Explain this idea in three practical steps.");
